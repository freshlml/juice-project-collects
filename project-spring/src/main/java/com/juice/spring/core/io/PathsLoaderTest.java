...
public class PathsLoaderTest {
    ...
    public static void loader() {
         ...
         * 使用Classloader加载资源
         */
        //bootstrap-classloader从sun.boot.class.path指定的路径中加载资源
    ...
    public static void test() throws Exception {
        ...
        //sun.boot.class.path写入的路径为: jdk安装目录\jre\lib\rt.jar，可以加载rt.jar包中的资源
        //如果写入的路径是jdk安装目录\jre\lib\，则可加载rt.jar本身和rt.jar包中的资源
        ...
        ress = classLoader.getResources("com/fresh");
        while(ress.hasMoreElements()) {
            System.out.println(ress.nextElement());
        }
