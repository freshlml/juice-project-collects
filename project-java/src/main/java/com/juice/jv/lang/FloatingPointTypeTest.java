 ...
 *
 *第六、数字类型转换
 *float <-> double模型图, float类型转换成double,其存储值被完整保留；double类型转换成float, 按舍入规则舍入
 *         符号位  .          .                                 |舍入                                                                  .
 ...
 *
 *
 *float -> byte模型图, 丢弃 "小数点" 后面的位，如果 "小数点" 在 "末尾" 之后，从 "末尾" 处截断
 *                   从数值层面看的表现: 丢弃小数点和小数部分，保留整数部分。如果整数部分在[-128, 127]之间，即得到该整数值，否则整数部分发生截断
 *         符号位  .          .   |末尾                  .        |舍入               .
 *  float     □     1□□□_□□□|□ □□□□_□□□□ □□□□_□□□□|⿱⿱⿱⿱_⿱⿱⿱⿱...⿱
 *  byte      □    □□□□_□□□|
 *byte -> float, 没有任何位丢失
 ...
 *
 *float -> short模型图, 丢弃 "小数点" 后面的位，如果 "小数点" 在 "末尾" 之后，从 "末尾" 处截断
 *                    从数值层面看的表现: 丢弃小数点和小数部分，保留整数部分。如果整数部分在[-32768, 32767]之间，即得到该整数值，否则整数部分发生截断
 *         符号位  .          .                 |末尾    .        |舍入               .
 *  float     □     1□□□_□□□□ □□□□_□□□|□ □□□□_□□□□|⿱⿱⿱⿱_⿱⿱⿱⿱...⿱
 *  short     □    □□□□_□□□□ □□□□_□□□|
 *short -> float, 没有任何位丢失
 ...
 *
 *float -> int模型图, 丢弃 "小数点" 后面的位，如果 "小数点" 在 "舍入" 之后，"舍入"位 到 "小数点"位 全是0，如果 "小数点" 在 "末尾" 之后，从 "末尾" 处截断
 *                  从数值层面看的表现: 丢弃小数点和小数部分，保留整数部分。如果整数部分在[-2^24, 2^24-1]之间，即得到该整数值；否者整数部分精度丢失(包括可能发生截断)
 *         符号位  .          .                                 |舍入       . |末尾          .
 *  float     □     1□□□_□□□□ □□□□_□□□□ □□□□_□□□□|⿱⿱⿱⿱_⿱⿱⿱|⿱ ⿱⿱⿱⿱...⿱
 *  int       □    □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□|
 *int -> float, 当数值 大于 2^24-1 或者小于 -2^24 时, 发生截断，可能造成数值精度丢失
 *
 *double -> int模型图, 丢弃 "小数点" 后面的位，如果 "小数点" 在 "末尾" 之后，从 "末尾" 处截断
 *                   从数值层面看的表现: 丢弃小数点和小数部分，保留整数部分。如果整数部分在[-2^31, 2^31-1]之间，即得到该整数值，否则整数部分发生截断
 *         符号位  .          .                                              |末尾                  .                   |舍入       .              .
 *  double    □     1□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□|□ □□□□_□□□□ □□□□_□□□□ □□□□_□|⿱⿱⿱⿱_⿱⿱⿱⿱ ⿱⿱⿱⿱...⿱
 *  int       □    □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□|
 *int -> double, 没有任何位丢失
 *
 *float -> long模型图, 丢弃 "小数点" 后面的位，如果 "小数点" 在 "舍入" 之后，"舍入"位 到 "小数点"位 全是0，如果 "小数点" 在 "末尾" 之后，从 "末尾" 处截断
 *                    从数值层面看的表现: 丢弃小数点和小数部分，保留整数部分。如果整数部分在[-2^24, 2^24-1]之间，即得到该整数值；否者整数部分精度丢失(包括可能发生截断)
 *         符号位  .          .                                 |舍入       .                                                           |末尾             .
 *  float     □     1□□□_□□□□ □□□□_□□□□ □□□□_□□□□|⿱⿱⿱⿱_⿱⿱⿱⿱ ⿱⿱⿱⿱_⿱⿱⿱⿱ ⿱⿱⿱⿱_⿱⿱⿱⿱ ⿱⿱⿱⿱_⿱⿱⿱⿱ ⿱⿱⿱⿱_⿱⿱⿱|⿱ ⿱⿱⿱⿱_⿱...⿱
 *  long      □    □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□|
 *long -> float, 当long的数值 大于 2^24-1 或者小于 -2^24 时, 发生截断，可能造成数值精度丢失
 *
 *double -> long模型图, 丢弃 "小数点" 后面的位，如果 "小数点" 在 "舍入" 之后，"舍入"位 到 "小数点"位 全是0，如果 "小数点" 在 "末尾" 之后，从 "末尾" 处截断
 *                    从数值层面看的表现: 丢弃小数点和小数部分，保留整数部分。如果整数部分在[-2^54, 2^54-1]之间，即得到该整数值；否者整数部分精度丢失(包括可能发生截断)
 *         符号位  .          .                                                                                       |舍入       .     |末尾      .
 *  double    □     1□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□|⿱⿱⿱⿱_⿱⿱⿱⿱ ⿱|⿱⿱⿱...⿱
 *  long      □    □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□□□□ □□□□_□ □□□ □□□□_□□□|
 *long -> double, 当long的数值 大于 2^54-1 或者小于 -2^54 时, 发生截断，可能造成数值精度丢失
 *
 *
 *
