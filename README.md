...
juice 项目下多个程序（工程）有相同的 groupId: com.fresh.juice，多个程序（工程）通过 artifactId 区分。多个程序（工程）有不同的 package name。
...
# juice-project-collects 说明
juice-project-collects 之中的程序（工程）不应该相互依赖。  
