...
public class Chapter5_4 {
     ...
     *Chapter 5.4.1
     *
     *一: 一年有 n 天(通常取 365 )，现有 k 个人，使得其中两个人生日相同的概率 > 50%，求 k？
     *
     *①
     *  k 个人，编号从 1 ~ k，每个人的生日与其他人无关，都是 n 天中的某一天
     *  令 i = 1, 2, ..., k. 令 bi 表示编号为 i 的人的生日, bi ∈ [1, 365]. 令 r = 1, 2, ..., n
     *
     ...
     *  每一次投球，球等可能的落在每一个箱子中，概率为 1/b, 假设一个箱子可以容纳多个球. 投球的过程是伯努利试验，成功的概率为 1/b, 成功是指球落入指定的箱子.
     *
     *  随机变量X: 落入指定箱子的球的数量
     *  X ~ b(k, n, 1/b)
     *  EX = np = n/b
     ...
     *  这个界大了...
     *
     *  随机变量Y: 获得 b 次命中所需的投球次数  //一次投球落在空箱子为一次命中
     *  Y = Y1 + ... + Yb, Yi 表示第 i 次命中所需的投球次数
     *    Y1  1
     *    P   1
     *
     *    Y2  1          2                      3                      ...
