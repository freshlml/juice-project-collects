...
public class Chapter2_9_2 {
     ...
     *   2.或者，有些算法是不稳定的，将导致相等元素的排位次序改变，这样，求出来的顺序统计量值是对的，但在原序列中的下标是不定的
     *   3.或者认为，相等的元素是一个顺序统计量
     *  partition，random_partition 均不稳定，符合上述2，可以考虑搭配range_partition返回一组下标
     *
     *  Chapter2_9_3的select 也不稳定，符合上述2
     *
     *  要符合3，可以考虑使用range_partition的思想来做适当修改
     *
     *
     *最坏情况运行时间: n^2
     *
