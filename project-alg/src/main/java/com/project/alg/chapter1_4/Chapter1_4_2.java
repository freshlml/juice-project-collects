...
public class Chapter1_4_2 {
     ...
     *如T(n) = 3*T(n/4) + n^2
     *                                      [n]
     *            [n/4]                    [n/4]                   [n/4]            第一层，n/4      1次merge, 1*n^2                           , 3份
     *    [n/16]  [n/16]  [n/16]   [n/16]  [n/16] [n/16]   [n/16]  [n/16] [n/16]    第二层，n/4^2    3次merge, 3*(n/4)^2                       , 3^2份
     *    ...
     *    ...                               [1]                             ...     第x层，n/4^x    3^(x-1)次merge, 3^(x-1) * [n/4^(x-1)]^2   , 3^x份
     *
     * 1.高度  n/4^x = 1 ==> 4^x = n ==> x=log4(n)
     * 2.分解+合并的消耗之和
