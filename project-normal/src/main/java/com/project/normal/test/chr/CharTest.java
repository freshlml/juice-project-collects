...
public class CharTest {
    ...
    public static void main(String argv[]) throws Exception {
         ...
         */
        String str = ", h 𝕆 中 😚 符 >";
        //编码: 将unicode字符序列按照"utf-8编码"转换成字节序列      值得注意的是，这里的"unicode字符序列"的说法是不准确的(在java中)，因为java中String使用char[]表示字符序列，每个char存unicode字符按照utf-16转化的代码单元值，不过这和char直接存储unicode字符的码点没有多大关系(至少是在"unicode字符序列这一说法上")
